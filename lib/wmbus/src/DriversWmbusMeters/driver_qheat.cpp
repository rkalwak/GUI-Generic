...
bool okQheat = registerDriver([](DriverInfo &di) {
  di.setName("qheat");
...
Driver::Driver(MeterInfo &mi, DriverInfo &di) : MeterCommonImplementation(mi, di) {
  addStringFieldWithExtractorAndLookup(
      "status", "Meter status.", DEFAULT_PRINT_PROPERTIES | PrintProperty::STATUS1 | PrintProperty::INCLUDE_TPL_STATUS,
  ...
  addNumericFieldWithExtractor("total_energy_consumption", "The total energy consumption recorded by this meter.", DEFAULT_PRINT_PROPERTIES,
                               Quantity::Energy, VifScaling::Auto,
                               FieldMatcher::build().set(MeasurementType::Instantaneous).set(VIFRange::AnyEnergyVIF));

  addStringFieldWithExtractor("last_month_date", "Last day previous month when total energy consumption was recorded.", DEFAULT_PRINT_PROPERTIES,
                              FieldMatcher::build().set(MeasurementType::Instantaneous).set(StorageNr(17)).set(VIFRange::Date));

  addNumericFieldWithExtractor("last_month_energy_consumption", "The total energy consumption recorded at the last day of the previous month.",
                               DEFAULT_PRINT_PROPERTIES, Quantity::Energy, VifScaling::Auto,
                               FieldMatcher::build().set(MeasurementType::Instantaneous).set(StorageNr(17)).set(VIFRange::AnyEnergyVIF));

  addStringFieldWithExtractor("last_year_date", "Last day previous year when total energy consumption was recorded.", DEFAULT_PRINT_PROPERTIES,
                              FieldMatcher::build().set(MeasurementType::Instantaneous).set(StorageNr(1)).set(VIFRange::Date));

  addNumericFieldWithExtractor("last_year_energy_consumption", "The total energy consumption recorded at the last day of the previous year.",
                               DEFAULT_PRINT_PROPERTIES, Quantity::Energy, VifScaling::Auto,
                               FieldMatcher::build().set(MeasurementType::Instantaneous).set(StorageNr(1)).set(VIFRange::AnyEnergyVIF));
  ...
  addStringFieldWithExtractor("device_error_date", "Device error date.", DEFAULT_PRINT_PROPERTIES,
...
// {"media":"heat","meter":"qheat","name":"QHeato","id":"67228058","status":"OK","total_energy_consumption_kwh":390.4,"last_month_date":"2021-09-30","last_month_energy_consumption_kwh":75.1,"last_year_date":"2020-12-31","last_year_energy_consumption_kwh":0,"device_date_time":"2021-10-22
// 13:40","device_error_date":"2127-15-31","timestamp":"1111-11-11T11:11:11Z"} |QHeato;67228058;390.4;2021-09-30;75.1;1111-11-11 11:11.11
...
// {"media":"heat","meter":"qheat","name":"Qheatoo","id":"67506579","status":"OK","total_energy_consumption_kwh":0,"last_month_date":"2022-08-31","last_month_energy_consumption_kwh":0,"last_year_date":"2127-15-31","last_year_energy_consumption_kwh":0,"device_date_time":"2022-09-27
// 13:58","device_error_date":"2127-15-31","timestamp":"1111-11-11T11:11:11Z"} |Qheatoo;67506579;0;2022-08-31;0;1111-11-11 11:11.11
...
// {"media":"heat","meter":"qheat","name":"Qheatoo","id":"32547698","status":"OK","total_energy_consumption_kwh":35226.8,"last_month_date":"2023-04-30","last_month_energy_consumption_kwh":35152.5,"last_year_date":"2022-12-31","last_year_energy_consumption_kwh":32258,"device_date_time":"2023-05-18
// 17:24","device_error_date":"2127-15-31","timestamp":"1111-11-11T11:11:11Z"} |Qheatoo;32547698;35226.8;2023-04-30;35152.5;1111-11-11 11:11.11
...
// {"media":"heat","meter":"qheat","name":"Qheatoo","id":"31547698","status":"OK","total_energy_consumption_kwh":35226.8,"last_month_date":"2023-04-30","last_month_energy_consumption_kwh":35152.5,"last_year_date":"2022-12-31","last_year_energy_consumption_kwh":32258,"device_date_time":"2023-05-18
// 17:25","timestamp":"1111-11-11T11:11:11Z"} |Qheatoo;31547698;35226.8;2023-04-30;35152.5;1111-11-11 11:11.11

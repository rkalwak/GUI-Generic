...
bool okRfmtx1 = registerDriver([](DriverInfo &di) {
  di.setName("rfmtx1");
...
Driver::Driver(MeterInfo &mi, DriverInfo &di) : MeterCommonImplementation(mi, di) {
  ...
  addStringFieldWithExtractor("meter_datetime", "Date time when meter sent this telegram.", DEFAULT_PRINT_PROPERTIES,
                              FieldMatcher::build().set(MeasurementType::Instantaneous).set(VIFRange::DateTime));
}

uchar decode_vectors_[16][6] = {
    {117, 150, 122, 16, 26, 10},  {91, 127, 112, 19, 34, 19},    {179, 24, 185, 11, 142, 153},  {142, 125, 121, 7, 74, 22},
    {181, 145, 7, 154, 203, 105}, {184, 163, 50, 161, 57, 14},   {189, 128, 156, 126, 96, 153}, {39, 92, 180, 196, 128, 163},
    {48, 208, 10, 206, 25, 3},    {194, 76, 240, 5, 165, 134},   {84, 75, 22, 152, 17, 94},     {75, 238, 12, 201, 125, 162},
...
// {"media":"water","meter":"rfmtx1","name":"Wasser","id":"74737271","total_m3":188.56,"meter_datetime":"2020-03-31
// 10:04:59","timestamp":"1111-11-11T11:11:11Z"} |Wasser;74737271;188.56;2020-03-31 10:04:59;1111-11-11 11:11.11

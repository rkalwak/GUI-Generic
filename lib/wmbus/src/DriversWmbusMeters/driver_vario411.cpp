...
bool okVario411 = registerDriver([](DriverInfo &di) {
  di.setName("vario411");
...
Driver::Driver(MeterInfo &mi, DriverInfo &di) : MeterCommonImplementation(mi, di) {
  ...
  addNumericFieldWithExtractor("target", "Total energy consumption at the end of the year", DEFAULT_PRINT_PROPERTIES, Quantity::Energy,
                               VifScaling::Auto,
                               FieldMatcher::build().set(MeasurementType::Instantaneous).set(VIFRange::AnyEnergyVIF).set(StorageNr(1)));

  addNumericFieldWithExtractor("target", "Date when previous year ended.", DEFAULT_PRINT_PROPERTIES, Quantity::PointInTime, VifScaling::Auto,
...
// {"id": "67627875","media": "heat","meter": "vario411","name": "Howdy","target_date": "2021-12-31","target_kwh":
// 6625,"timestamp":"1111-11-11T11:11:11Z"} |Howdy;67627875;6625;2021-12-31;1111-11-11 11:11.11

...
bool okWme5 = registerDriver([](DriverInfo &di) {
  di.setName("wme5");
...
Driver::Driver(MeterInfo &mi, DriverInfo &di) : MeterCommonImplementation(mi, di) {
  ...
  addNumericField("total", Quantity::Volume, DEFAULT_PRINT_PROPERTIES, "Perhaps the total water consumption recorded by this meter.");

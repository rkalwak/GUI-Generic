...
meter1->add_sensor(new Supla::Sensor::SensorBase("004444DD", "apator08", "total", "", Unit::M3));
...
meter2->add_sensor(new Supla::Sensor::SensorBase("20202020", "apator162", "total", "", Unit::M3));
...
meter3->add_sensor(new Supla::Sensor::SensorBase("12345699", "iperl", "total", "", Unit::M3));
...
meter4->add_sensor(new Supla::Sensor::SensorBase("02410120", "mkradio4", "total", "", Unit::M3));

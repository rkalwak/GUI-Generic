...
void handleSensorSpi(int save) {
  ...
  addFormHeader(S_GPIO_SETTINGS_FOR S_SPACE S_SPI);
...
#ifdef SUPLA_CC1101
  addFormHeader(S_GPIO_SETTINGS_FOR S_SPACE "CC1101");
  ...
  if (ConfigESP->getGpio(FUNCTION_CLK) != OFF_GPIO && ConfigESP->getGpio(FUNCTION_CS) != OFF_GPIO && ConfigESP->getGpio(FUNCTION_MISO) != OFF_GPIO &&
    ...
    if (ConfigManager->get(KEY_ACTIVE_SENSOR_2)->getElement(SENSOR_SPI_CC1101).toInt()) {
      ...
      addListBox(INPUT_WMBUS_SENSOR_TYPE1, S_WMBUS_SENSOR_TYPE, sensors_types, 28, selected);
      ...
      addListBox(INPUT_WMBUS_SENSOR_PROP1, S_WMBUS_SENSOR_PROP, sensors_properties, 43, selected);
      ...
      addListBox(INPUT_WMBUS_SENSOR_TYPE2, S_WMBUS_SENSOR_TYPE, sensors_types, 28, selected);
      ...
      addListBox(INPUT_WMBUS_SENSOR_PROP2, S_WMBUS_SENSOR_PROP, sensors_properties, 43, selected);
      ...
      addListBox(INPUT_WMBUS_SENSOR_TYPE3, S_WMBUS_SENSOR_TYPE, sensors_types, 28, selected);
      ...
      addListBox(INPUT_WMBUS_SENSOR_PROP3, S_WMBUS_SENSOR_PROP, sensors_properties, 43, selected);
      ...
      // fourth sensor
      addFormHeader(String(S_WMBUS_METER) + " 4");
      selected = ConfigManager->get(KEY_WMBUS_SENSOR)->getElement(WMBUS_CFG_SENSOR_ENABLED4).toInt();
      addCheckBox(INPUT_WMBUS_SENSOR_ENABLED4, S_ON, selected);
      selected = ConfigManager->get(KEY_WMBUS_SENSOR)->getElement(WMBUS_CFG_SENSOR_TYPE4).toInt();
      addListBox(INPUT_WMBUS_SENSOR_TYPE4, S_WMBUS_SENSOR_TYPE, sensors_types, 28, selected);
      String sensorId4 = ConfigManager->get(KEY_WMBUS_SENSOR_ID)->getElement(3);
      addTextBox(INPUT_WMBUS_SENSOR_ID4, S_WMBUS_SENSOR_ID, sensorId4.c_str(), 1, 9, false);
      ...
      addListBox(INPUT_WMBUS_SENSOR_PROP4, S_WMBUS_SENSOR_PROP, sensors_properties, 43, selected);
      ...
      selected = ConfigManager->get(KEY_WMBUS_SENSOR)->getElement(WMBUS_CFG_SENSOR_TYPE5).toInt();
      addListBox(INPUT_WMBUS_SENSOR_TYPE5, S_WMBUS_SENSOR_TYPE, sensors_types, 28, selected);
      String sensorId5 = ConfigManager->get(KEY_WMBUS_SENSOR_ID)->getElement(4);
      addTextBox(INPUT_WMBUS_SENSOR_ID5, S_WMBUS_SENSOR_ID, sensorId5.c_str(), 1, 9, false);
      ...
      addListBox(INPUT_WMBUS_SENSOR_PROP5, S_WMBUS_SENSOR_PROP, sensors_properties, 43, selected);
      ...
      selected = ConfigManager->get(KEY_WMBUS_SENSOR)->getElement(WMBUS_CFG_SENSOR_TYPE6).toInt();
      addListBox(INPUT_WMBUS_SENSOR_TYPE6, S_WMBUS_SENSOR_TYPE, sensors_types, 28, selected);
      String sensorId6 = ConfigManager->get(KEY_WMBUS_SENSOR_ID)->getElement(5);
      addTextBox(INPUT_WMBUS_SENSOR_ID6, S_WMBUS_SENSOR_ID, sensorId6.c_str(), 1, 9, false);
      ...
      addListBox(INPUT_WMBUS_SENSOR_PROP6, S_WMBUS_SENSOR_PROP, sensors_properties, 43, selected);
      ...
      addListBox(INPUT_WMBUS_SENSOR_TYPE7, S_WMBUS_SENSOR_TYPE, sensors_types, 28, selected);
      ...
      addListBox(INPUT_WMBUS_SENSOR_PROP7, S_WMBUS_SENSOR_PROP, sensors_properties, 43, selected);
      ...
      addListBox(INPUT_WMBUS_SENSOR_TYPE8, S_WMBUS_SENSOR_TYPE, sensors_types, 28, selected);
      ...
      addListBox(INPUT_WMBUS_SENSOR_PROP8, S_WMBUS_SENSOR_PROP, sensors_properties, 43, selected);
      ...
      addListBox(INPUT_WMBUS_SENSOR_TYPE9, S_WMBUS_SENSOR_TYPE, sensors_types, 28, selected);
      ...
      addListBox(INPUT_WMBUS_SENSOR_PROP9, S_WMBUS_SENSOR_PROP, sensors_properties, 43, selected);
      ...
      addListBox(INPUT_WMBUS_SENSOR_TYPE10, S_WMBUS_SENSOR_TYPE, sensors_types, 28, selected);
      ...
      addListBox(INPUT_WMBUS_SENSOR_PROP10, S_WMBUS_SENSOR_PROP, sensors_properties, 43, selected);
...
void handleSensorSpiSave() {
  ...
  // fifth sensor is optional
  input = INPUT_WMBUS_SENSOR_ENABLED5;
  elementIndex = 4;
  if (strcmp(WebServer->httpServer->arg(input).c_str(), "") != 0) {
    ConfigManager->setElement(KEY_WMBUS_SENSOR, WMBUS_CFG_SENSOR_ENABLED5, 1);
    input = INPUT_WMBUS_SENSOR_TYPE5;
    if (strcmp(WebServer->httpServer->arg(input).c_str(), "") != 0) {
      ConfigManager->setElement(KEY_WMBUS_SENSOR, WMBUS_CFG_SENSOR_TYPE5, static_cast<int>(WebServer->httpServer->arg(input).toInt()));
    }
  
    input = INPUT_WMBUS_SENSOR_ID5;
    ConfigManager->setElement(KEY_WMBUS_SENSOR_ID, elementIndex, WebServer->httpServer->arg(input).c_str());

    input = INPUT_WMBUS_SENSOR_KEY5;
    ConfigManager->setElement(KEY_WMBUS_SENSOR_KEY, elementIndex, WebServer->httpServer->arg(input).c_str());

    input = INPUT_WMBUS_SENSOR_PROP5;
    if (strcmp(WebServer->httpServer->arg(input).c_str(), "") != 0) {
  ...
  {
    ConfigManager->setElement(KEY_WMBUS_SENSOR, WMBUS_CFG_SENSOR_ENABLED5, 0);
  }
  // fifth sensor

  // sixth sensor is optional
  input = INPUT_WMBUS_SENSOR_ENABLED6;
  elementIndex = 5;
  if (strcmp(WebServer->httpServer->arg(input).c_str(), "") != 0) {
    ConfigManager->setElement(KEY_WMBUS_SENSOR, WMBUS_CFG_SENSOR_ENABLED6, 1);
    input = INPUT_WMBUS_SENSOR_TYPE6;
    if (strcmp(WebServer->httpServer->arg(input).c_str(), "") != 0) {
      ConfigManager->setElement(KEY_WMBUS_SENSOR, WMBUS_CFG_SENSOR_TYPE6, static_cast<int>(WebServer->httpServer->arg(input).toInt()));
    }
  
    input = INPUT_WMBUS_SENSOR_ID6;
    ConfigManager->setElement(KEY_WMBUS_SENSOR_ID, elementIndex, WebServer->httpServer->arg(input).c_str());

    input = INPUT_WMBUS_SENSOR_KEY6;
    ConfigManager->setElement(KEY_WMBUS_SENSOR_KEY, elementIndex, WebServer->httpServer->arg(input).c_str());
  ...
  {
    ConfigManager->setElement(KEY_WMBUS_SENSOR, WMBUS_CFG_SENSOR_ENABLED6, 0);
  }
  // sixth sensor
